...
public class RandomGraphGenerator {
	...
	public void createRandomEdges(int numberOfEdges){
		...
		if(gpc.getSelectedTabName().equals("Undirected Non-Weighted Graph")) {
			...
			if(dataType.equals("Integer")) {
				...
				int numberOfVertices = gpc.getDataModel().getUndirectedNonWeightedInt().getAdjacencyList().size();
...
//                			
//                			if(toCompare.equals(pairToAdd.getKey().toString())) {
//                				stackPane1 = (StackPane) child;
//                			}else if(toCompare.equals(pairToAdd.getValue().toString())) {
...
//					
				...
				int numberOfVertices = gpc.getDataModel().getUndirectedNonWeightedDouble().getAdjacencyList().size();
				...
				int numberOfVertices = gpc.getDataModel().getUndirectedNonWeightedString().getAdjacencyList().size();
